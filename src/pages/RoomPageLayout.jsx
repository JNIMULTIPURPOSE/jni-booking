...
export default function RoomPageLayout({
  ...
  const submitBooking = async () => {
    if (!bookingForm.name || !bookingForm.phone || !bookingForm.checkin) {
    ...
    try {
      const newBooking = {
        ...
        category: selectedListing?.category || category,
    ...
    <div style={styles.page}>
      ...
      {filteredListings.length === 0 ? (
        <div style={styles.empty}>
          ...
          <p>Admin-added listings will appear here automatically.</p>
        </div>
      ) : (
      ...
      <button
        ...
        onClick={() => setGeneralBooking(true)}
      >
        📅 Request Booking
      </button>

      {/* MODAL */}
      {(selectedListing || generalBooking) && (
          ...
          <div style={styles.modal}>
            ...
            {selectedListing && (
              <div style={styles.propertyInfo}>
                ...
                <p>🛏️ {selectedListing.roomType}</p>
            ...
            <div style={styles.modalActions}>
              <button style={styles.cancelBtn} onClick={closeBooking}>
                Cancel
              </button>

              <button style={styles.confirmBtn} onClick={submitBooking}>
                Confirm Booking
              </button>
            </div>
          </div>
